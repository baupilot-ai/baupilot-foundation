...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BauPilot AI — Construction SaaS Platform" },
      {
        name: "description",
        content:
          "BauPilot AI is the modern multi-tenant SaaS platform for construction companies to manage projects, teams, and operations.",
      },
      { name: "author", content: "BauPilot AI" },
      { property: "og:title", content: "BauPilot AI" },
      { property: "og:description", content: "Construction SaaS platform foundation." },
